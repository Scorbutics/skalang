...
void ska::BindingFactory::listen(SymbolTable& symbolTable) {
	Observable<VarTokenEvent>::addObserver(symbolTable);
	Observable<FunctionTokenEvent>::addObserver(symbolTable);
	Observable<BlockTokenEvent>::addObserver(symbolTable);
	Observable<BridgeTokenEvent>::addObserver(symbolTable);
}

void ska::BindingFactory::unlisten(SymbolTable& symbolTable) {
	Observable<BridgeTokenEvent>::removeObserver(symbolTable);
	Observable<BlockTokenEvent>::removeObserver(symbolTable);
	Observable<FunctionTokenEvent>::removeObserver(symbolTable);
	Observable<VarTokenEvent>::removeObserver(symbolTable);
}
