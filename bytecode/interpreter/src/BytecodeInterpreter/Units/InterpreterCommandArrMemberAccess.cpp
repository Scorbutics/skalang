...
#include "InterpreterCommandArrMemberAccess.h"
...
SKALANG_BYTECODE_INTERPRETER_COMMAND_DECLARE(ARR_MEMBER_ACCESS)(ExecutionContext& context, const Operand& left, const Operand& right) {
