...
SKA_LOGC_CONFIG(ska::LogLevel::Info, ska::bytecode::Generator);
...
ska::bytecode::GenerationOutput ska::bytecode::Generator::generate(BytecodeStorage& storage, ScriptGenerationService script) {
